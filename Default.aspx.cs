...
namespace gmap
{
    public partial class _Default : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            dt.Rows.Add("Text 1", "T1");
            dt.Rows.Add("Text 2", "T2");
            dt.Rows.Add("Text 3", "T3");
            ddlCountry.DataSource = dt;
            ddlCountry.DataMember = "Value";
        ...
        protected void ddlCountry_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                Page.ClientScript.RegisterStartupScript(this.GetType(), "window", "CreateMarker('" + ddlCountry.SelectedValue + "');", true);
            }
            //Page.ClientScript.RegisterStartupScript(this.GetType(), "CallCreateMarker", "CreateMarker('" + ddlCountry .SelectedValue+ "')", true);
        }
